...
public class FilteredShareActionProvider extends ShareActionProvider {
    ...
    public View onCreateActionView() {
        ...
        FilteredActivityChooserView activityChooserView = new FilteredActivityChooserView(mContext);
        activityChooserView.setFilteredActivityChooserModel(dataModel);
    ...
    public void setShareIntent(Intent shareIntent) {
        FilteredActivityChooserModel dataModel = FilteredActivityChooserModel.get(mContext,
    ...
    private void setActivityChooserPolicyIfNeeded() {
        ...
        if (mOnChooseActivityListener == null) {
            mOnChooseActivityListener = new ShareFilteredActivityChooserModelPolicy();
        }
        FilteredActivityChooserModel dataModel = FilteredActivityChooserModel.get(mContext, mShareHistoryFileName);
     ...
     */
    private class ShareFilteredActivityChooserModelPolicy implements OnChooseActivityListener {
        @Override
        public boolean onChooseActivity(FilteredActivityChooserModel host, Intent intent) {
            if (mOnShareTargetSelectedListener != null) {
                mOnShareTargetSelectedListener.onShareTargetSelected(
                        FilteredShareActionProvider.this, intent);
            }
            return false;
        }
    }
