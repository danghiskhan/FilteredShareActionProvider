 ...
 * @hide
 */
public class FilteredActivityChooserView extends ViewGroup implements
        FilteredActivityChooserModel.FilteredActivityChooserModelClient {
     ...
     */
    public FilteredActivityChooserView(Context context) {
        this(context, null);
    }
     ...
     */
    public FilteredActivityChooserView(Context context, AttributeSet attrs) {
    ...
    public FilteredActivityChooserModel getDataModel() {
    ...
    private ListPopupWindow getListPopupWindow() {
        if (mListPopupWindow == null) {
            ...
            mListPopupWindow.setAnchorView(FilteredActivityChooserView.this);
    ...
    private class ActivityChooserViewAdapter extends BaseAdapter {
        ...
        private FilteredActivityChooserModel mDataModel;
        ...
        public void setDataModel(FilteredActivityChooserModel dataModel) {
            FilteredActivityChooserModel oldDataModel = mAdapter.getDataModel();
